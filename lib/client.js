window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var css = [
      ...
      '.gw-foot-wrap{align-items:center;width:100%;display:flex}',
      ...
      '.gw-foot-wrap-rail{width:auto;flex-direction:column;gap:2px}',
    ...
    function apply(ctx) {
      ...
      function GameWorldToggle(props) {
        ...
        return React.createElement('div', { className: props.wide ? 'gw-foot-wrap' : 'gw-foot-wrap gw-foot-wrap-rail' },

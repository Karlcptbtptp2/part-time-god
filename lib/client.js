window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var css = [
      ...
      '.gw-foot-btn{position:relative;height:49px;flex:1 1 0;min-width:0;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:0 8px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}',
      '.gw-foot-btn:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}',
      '.gw-foot-btn-rail{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0;flex:0 0 auto}',

window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var css = [
      ...
      '.gw-foot-btn{position:relative;height:49px;flex:0 0 auto;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:0 10px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}',
